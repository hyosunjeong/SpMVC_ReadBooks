...
<header class="main-header"><h2>독서록 수정</h2></header>
...
<form action="<c:url value='/update'/>" method="POST" class="main-box">
	...
	<label for="b_date">독서일자</label>
		<input type="text" id="b_date" class="in-box" name="b_date" value="${BOOK.b_date}"><br/>
	...
	<button type="submit" id="book_up_check">수정확인</button>
